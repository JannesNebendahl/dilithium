...
void main() {
  ...
  group('Dilithium2', () {
    ...
    final Uint8List seed =
        Uint8List.fromList(List<int>.generate(Dilithium.SEEDBYTES, (i) => i));
    ...
    final DilithiumPrivateKey privateKey =
        DilithiumPrivateKey.deserialize(spec, prvBytes);
    ...
    final DilithiumPublicKey publicKey =
        DilithiumPublicKey.deserialize(spec, pubBytes);

    final Uint8List message =
        Uint8List.fromList([0x54, 0x65, 0x73, 0x74]); // == "Test"
    ...
    test('generateKeyPair throws InvalidSeedLength', () {
      expect(
          () => Dilithium.generateKeyPair(
              spec, Uint8List(Dilithium.SEEDBYTES + 1)),
          throwsA(isA<InvalidSeedLength>()));
    });
    ...
    test('verify', () {
      Uint8List invalidMsg = Uint8List.fromList(
