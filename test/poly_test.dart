...
void main() {
  group('Poly', () {
    ...
    test('pointwiseMontgomery', () {
      ...
      List<int> coefP2 =
          List<int>.generate(Dilithium.N, (index) => (index + 1) * 2);
    ...
    test('reduce', () {
      List<int> coefficients =
          List<int>.generate(Dilithium.N, (index) => index + Dilithium.Q);
    ...
    test('invnttTomont', () {
      List<int> coefficients =
          List<int>.generate(Dilithium.N, (index) => index + 1);
      Poly p = Poly(Dilithium.N)..coef = coefficients;
    ...
    test('powerRound', () {
      List<int> coefficients =
          List<int>.generate(Dilithium.N, (index) => index);
      Poly p = Poly(Dilithium.N)..coef = coefficients;

      List<Poly> result = p.powerRound();

      List<int> expectedCoef0 = [
        0,
        1,
        2,
        3,
    ...
    test('t1pack', () {
      ...
      Uint8List r =
          Uint8List.fromList(List<int>.filled((Dilithium.N ~/ 4) * 5, 0));
      p.t1pack(r, 0);
    ...
    test('etapack eta = 2', () {
      List<int> coefficients =
          List<int>.generate(Dilithium.N, (index) => index % 3);
      Poly p = Poly(Dilithium.N)..coef = coefficients;

      Uint8List buf =
          Uint8List.fromList(List<int>.filled(Dilithium.N ~/ 8 * 3, 0));
      p.etapack(2, buf, 0);
    ...
    test('t0pack', () {
      ...
      Uint8List buf =
          Uint8List.fromList(List<int>.filled(Dilithium.N ~/ 8 * 13, 0));
      p.t0pack(buf, 0);

      List<int> expectedBuf = [
        0x0,
        0xF0,
        0xFF,
        0xF9,
    ...
    test('genRandomGamma1 invalid gamma', () {
      ...
      expect(() => Poly.genRandomGamma1(seed, 0, Dilithium.N, 1),
    ...
    test('w1pack gamma2 == ((Dilithium.Q - 1) ~/ 88)', () {
      List<int> coefficients =
          List<int>.generate(Dilithium.N, (index) => index % 16);
      Poly p = Poly(Dilithium.N)..coef = coefficients;
    ...
    test('chknorm', () {
      Poly p = Poly(Dilithium.N)
        ..coef = List<int>.generate(Dilithium.N, (index) => index % 100);
    ...
    test('zpack', () {
      Poly p = Poly(Dilithium.N)
        ..coef = List<int>.generate(Dilithium.N, (index) => index % (1 << 17));
    ...
    test('shiftl', () {
      Poly p = Poly(Dilithium.N)
        ..coef = List<int>.generate(Dilithium.N, (index) => index);
