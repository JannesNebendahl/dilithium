...
void main() {
  group('PolyVec', () {
    ...
    test('add', () {
      final pv1 = mockPolyVec([
        [1, 2, 3]
      ]);
      final pv2 = mockPolyVec([
        [4, 5, 6]
      ]);
    ...
    test('randomVec throws IllegalEta', () {
      ...
      expect(
          () => PolyVec.randomVec(rho, 3, 1, 123), throwsA(isA<IllegalEta>()));
    });
    ...
    test('powerRound', () {
      ...
      final expectedRounded = mockPolyVec([
        [
          1525,
          -2137,
          144,
      ...
      final expectedRemaining = mockPolyVec([
        [
          -505,
          -408,
          -373,
